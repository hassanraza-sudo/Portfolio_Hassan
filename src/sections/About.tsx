          ...
          <div className="lg:col-span-5 flex flex-col items-start gap-6 text-left">
            ...
            <div className="space-y-4 text-slate-400 text-sm md:text-base leading-relaxed font-light">
              <p>
                ...
                , a Full Stack Developer who enjoys transforming ideas into
                modern, scalable digital products. With a strong foundation in
                React, Node.js, Express, and MongoDB, I build applications that
                balance performance, usability, and clean architecture.
              </p>
              <p>
                I'm passionate about continuous learning and collaborating with
                teams to deliver software that creates real value.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 mt-2">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase font-mono tracking-wider text-slate-500 mt-1">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2 p-6 rounded-2xl border border-dashed border-white/10 bg-slate-950/20 text-left flex flex-col justify-center items-start gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[9px] uppercase tracking-wider text-blue-400 font-bold">
                  Philosophical Directive
                </span>
              </div>
              <p className="text-[#94a3b8] italic text-xs md:text-sm font-light leading-relaxed">
                "Great products are not measured by the volume of features, but
                by the seamless quality of their core workflows. Elegant design
                and strong, simple engineering build trust."
              </p>
            </div>
          </div>
        </div>
